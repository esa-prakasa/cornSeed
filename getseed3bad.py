...
fileNmSet = os.listdir(pathToRead)

maxNumOfFile = len(fileNmSet) - 4

#for fileIdx in range(3):
#for fileIdx in range(maxNumOfFile): #<< error at idx 49, 50, 51
#for fileIdx in range(52,maxNumOfFile): ## 52 t0 63
#for fileIdx in range(65,maxNumOfFile): ## 65 t0 67
#for fileIdx in range(69,maxNumOfFile): ## 69 t0 75
print(maxNumOfFile)
#for fileIdx in range(77,maxNumOfFile): ## 77 t0 85
#for fileIdx in range(93,maxNumOfFile): ## 77 t0 85
for fileIdx in range(98,maxNumOfFile): ## 77 t0 85
...
##pathToRead = "C:\\Users\\INKOM06\\Pictures\\jagung2020\\0304\\"+fileNmSet[fileIdx]
	...
	gray = hsv[:,:,2]
	ret, bwImg = cv2.threshold(gray,80,255,cv2. THRESH_BINARY)
